  ...
  return (
    <div className={styles.page}>
      <Section>
        ...
        {photos.length > 0 ? <ClientMyProfilePhotos photos={photos} /> : <Typography>投稿写真がありません</Typography>}
      </Section>
      <Pagination currentPage={+page} pagination={pagination} pathname="/profile" />
    </div>
  )
}
