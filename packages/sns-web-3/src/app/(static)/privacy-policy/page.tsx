...
export default function Page() {
  return (
    <div className={styles.page}>
      ...
      <Section>
        <Typography tag="p">本規約は、Chat GPT により生成した、架空のサービス規約です。</Typography>
      ...
      <Section>
        ...
        <Typography tag="p">当社は、以下の場合には、利用登録を拒否することができます。</Typography>
        <ul className={styles.list}>
          <Typography tag="li">登録内容に虚偽、誤記、省略がある場合</Typography>
          <Typography tag="li">当社が指定する年齢未満の者が申し込みをした場合</Typography>
          <Typography tag="li">過去に本サービスの利用を停止された者が申し込みをした場合</Typography>
      ...
      <Section>
        ...
        <Typography tag="p">当社は、ユーザーに対し、以下の行為を禁止します。</Typography>
        <ul className={styles.list}>
          <Typography tag="li">法令または公序良俗に違反する行為</Typography>
          <Typography tag="li">犯罪行為に関連する行為</Typography>
          <Typography tag="li">当社のサーバーやネットワークの機能を破壊したり、妨害したりする行為</Typography>
          <Typography tag="li">当社のサービスを利用して不正行為をすること</Typography>
          <Typography tag="li">他のユーザーに対する威嚇や誹謗中傷、またはプライバシーを侵害する行為</Typography>
          <Typography tag="li">他のユーザーに成りすます行為</Typography>
          <Typography tag="li">他人の著作権、商標権、プライバシー権、名誉権等を侵害する行為</Typography>
          <Typography tag="li">商業的な広告、宣伝、勧誘行為（当社が認めたものを除く）</Typography>
          <Typography tag="li">性行為や暴力行為を描写した画像や文言を投稿、または伝播する行為</Typography>
      ...
      <Section>
        ...
        <ul className={styles.list}>
          <Typography tag="li">本サービスにかかるコンピュータシステムの保守点検または更新を行う場合</Typography>
          <Typography tag="li">
            地震、落雷、火災、風水害、停電または公害等の非常事態により、本サービスの提供が困難となった場合
          </Typography>
          <Typography tag="li">コンピュータまたは通信回線等が事故により停止した場合</Typography>
          <Typography tag="li">その他、当社が本サービスの提供が困難と判断した場合</Typography>
        </ul>
      </Section>
      <Section>
      ...
      <Section>
        ...
        <ul className={styles.list}>
          ...
          <Typography tag="li">登録内容に虚偽があることが判明した場合</Typography>
          <Typography tag="li">支払い遅延等がある場合</Typography>
          <Typography tag="li">その他、当社が本サービスの利用を適当でないと判断した場合</Typography>
        </ul>
      </Section>
      <Section>
      ...
      <Section>
        ...
        <Typography tag="p">本規約の解釈にあたっては、日本法を準拠法とします。</Typography>
        <Typography tag="p">
