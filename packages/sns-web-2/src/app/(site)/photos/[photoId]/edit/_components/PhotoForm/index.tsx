...
function PhotoFormTitle({ title, error }: { title: string; error?: string }) {
  ...
  return (
    <Section>
      ...
      <TextField id={id} className={styles.title} name="title" defaultValue={title} />
...
function PhotoDescription({ description, error }: { description: string; error?: string }) {
  ...
  return (
    <Section>
      ...
      <TextArea id={id} className={styles.description} name="description" defaultValue={description} />
      {error && <AlertText>{error}</AlertText>}
    </Section>
  )
}
  ...
  return (
    <form action={formDispatch}>
      ...
      <div className={styles.content}>
        <div>
          <PhotoFormTitle title={photo.title} error={formState?.error?.fieldErrors?.["title"].message} />
